...
const EXPECTED_PACKAGES = [
  ...
  {
    directory: "dream-org",
    packageName: "@cyberlangke/tokkit-dream-org",
    license: "Apache-2.0",
    includedInAll: true,
  ...
  {
    directory: "sarvamai",
    packageName: "@cyberlangke/tokkit-sarvamai",
    license: "Apache-2.0",
    includedInAll: true,
    requiredFiles: ["COPYRIGHT", "LICENSE"],
  },
  ...
  {
    directory: "primeintellect",
    packageName: "@cyberlangke/tokkit-primeintellect",
    license: "Apache-2.0",
    includedInAll: true,
    requiredFiles: ["COPYRIGHT", "LICENSE"],
  },
  ...
  {
    directory: "essentialai",
    packageName: "@cyberlangke/tokkit-essentialai",
    license: "Apache-2.0",
    includedInAll: true,
  },
  {
  ...
  {
    directory: "zyphra",
    packageName: "@cyberlangke/tokkit-zyphra",
    license: "Apache-2.0",
    includedInAll: true,
  },
  {
    directory: "arcee-ai",
    packageName: "@cyberlangke/tokkit-arcee-ai",
    license: "Apache-2.0",
    includedInAll: true,
    requiredFiles: ["COPYRIGHT", "LICENSE"],
  },
  {
    directory: "state-spaces",
    packageName: "@cyberlangke/tokkit-state-spaces",
    license: "Apache-2.0",
    includedInAll: true,
    requiredFiles: ["COPYRIGHT", "LICENSE"],
  },
  {
    directory: "snowflake",
    packageName: "@cyberlangke/tokkit-snowflake",
    license: "Apache-2.0",
    includedInAll: true,
    requiredFiles: ["COPYRIGHT", "LICENSE"],
  },
  ...
  {
    directory: "swiss-ai",
    packageName: "@cyberlangke/tokkit-swiss-ai",
    license: "Apache-2.0",
    includedInAll: true,
    requiredFiles: ["COPYRIGHT", "LICENSE"],
  },
...
describe("workspace layout", () => {
  ...
  it("primeintellect alias 包构建前会先生成依赖子包的类型产物", () => {
    const packageJsonPath = resolve(REPO_ROOT, "packages", "primeintellect", "package.json")
    const packageJson = JSON.parse(readFileSync(packageJsonPath, "utf8")) as {
      scripts?: Record<string, string>
    }
