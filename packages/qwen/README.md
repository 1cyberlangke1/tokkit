...
- `qwen2.5`：覆盖 Apache-2.0 的 `Qwen2.5` 主线 / `Qwen2.5-Coder` 主线 / `Qwen2.5-Math` 主线，以及共享同一 tokenizer 的 `QwQ-32B-Preview`、`Qwen3-0.6B-Base / 1.7B-Base / 4B-Base / 8B-Base`
- `qwen3`：覆盖 `Qwen3-0.6B / 1.7B / 4B / 8B / 14B / 30B-A3B / 32B / 235B-A22B` 及其当前 Apache-2.0 instruct / thinking / next 变体
...
- `qwen3-coder-next`：覆盖 `Qwen3-Coder-Next`、`Qwen3-Coder-30B-A3B-Instruct`、`Qwen3-30B-A3B-Thinking-2507`、`QwQ-32B`
