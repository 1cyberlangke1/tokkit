/**
 * baidu family 包公共入口。
 * 输入：baidu family 名称或其模型别名。
 * 输出：自动注册 baidu 内置 family，并复用 core 的公共 API。
 */
...
const BUILTIN_FAMILIES = [
  {
    ...
    modulePath: "./generated/ernie_4_5.js",
  },
  {
    family: "ernie-4.5-thinking",
    aliases: ["ernie_4_5_thinking"],
    models: ["baidu/ERNIE-4.5-21B-A3B-Thinking"],
    modulePath: "./generated/ernie_4_5_thinking.js",
  },
] as const

/**
 * 注册 baidu 子包内置的 family。
 * 输入：无。
 * 输出：baidu 相关 family 被写入全局注册表。
 */
