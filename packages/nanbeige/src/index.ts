/**
 * Nanbeige family 包公共入口。
 * 输入：Nanbeige family 名称或其模型别名。
 * 输出：自动注册 Nanbeige 内置 family，并复用 core 的公共 API。
 */
...
const BUILTIN_FAMILIES = [
  {
    ...
    modulePath: "./generated/nanbeige4.js",
  },
  {
    family: "nanbeige4-base",
    aliases: ["nanbeige4_base"],
    models: ["Nanbeige/Nanbeige4-3B-Base"],
    modulePath: "./generated/nanbeige4_base.js",
  },
] as const

/**
 * 注册 Nanbeige 子包内置的 family。
 * 输入：无。
 * 输出：Nanbeige 相关 family 被写入全局注册表。
 */
