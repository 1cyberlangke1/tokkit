/**
 * DistilBERT family 包公共入口。
 * 输入：DistilBERT family 名称或其模型别名。
 * 输出：自动注册 DistilBERT 内置 family，并复用 core 的公共 API。
 */
...
const BUILTIN_FAMILIES = [
  {
    ...
    modulePath: "./generated/distilgpt2.js",
  },
] as const

/**
 * 注册 DistilBERT 子包内置的 family。
 * 输入：无。
 * 输出：DistilBERT 相关 family 被写入全局注册表。
 */
