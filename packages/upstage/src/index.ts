/**
 * Upstage family 包公共入口。
 * 输入：Upstage family 名称或其模型别名。
 * 输出：自动注册 Upstage 内置 family，并复用 core 的公共 API。
 */
...
const BUILTIN_FAMILIES = [
  {
    family: "solar",
    aliases: ["solar_10_7b", "tinysolar_248m_4k"],
    models: ["upstage/SOLAR-10.7B-v1.0", "upstage/TinySolar-248m-4k"],
    modulePath: "./generated/solar.js",
  },
  {
    family: "solar-pro",
    aliases: ["solar_pro", "solar_pro_preview"],
    models: ["upstage/solar-pro-preview-instruct"],
    modulePath: "./generated/solar_pro.js",
  },
] as const

/**
 * 注册 Upstage 子包内置的 family。
 * 输入：无。
 * 输出：Upstage 相关 family 被写入全局注册表。
 */
