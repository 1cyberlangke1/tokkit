/**
 * ai21labs family 包公共入口。
 * 输入：ai21labs family 名称或其模型别名。
 * 输出：自动注册 ai21labs 内置 family，并复用 core 的公共 API。
 */
...
const BUILTIN_FAMILIES = [
  {
    ...
    modulePath: "./generated/jamba2.js",
  },
  {
    family: "jamba-v0.1",
    aliases: ["jamba_v0_1"],
    models: ["ai21labs/Jamba-v0.1"],
    modulePath: "./generated/jamba_v0_1.js",
  },
] as const

/**
 * 注册 ai21labs 子包内置的 family。
 * 输入：无。
 * 输出：ai21labs 相关 family 被写入全局注册表。
 */
