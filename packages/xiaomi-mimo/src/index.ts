/**
 * XiaomiMiMo family 包公共入口。
 * 输入：MiMo family 名称或其模型别名。
 * 输出：自动注册 MiMo 内置 family，并复用 core 的公共 API。
 */
...
const BUILTIN_FAMILIES = [
  {
    ...
    modulePath: "./generated/mimo.js",
  },
  {
    family: "mimo-7b-rl-0530",
    aliases: ["mimo_7b_rl_0530"],
    models: ["XiaomiMiMo/MiMo-7B-RL-0530"],
    modulePath: "./generated/mimo_7b_rl_0530.js",
  },
  {
    family: "mimo-v2-flash",
    aliases: ["mimo_v2_flash"],
    models: ["XiaomiMiMo/MiMo-V2-Flash"],
    modulePath: "./generated/mimo_v2_flash.js",
  },
] as const

/**
 * 注册 XiaomiMiMo 子包内置的 family，可按 family 名称过滤。
 * 输入：可选的 family 名称列表。
 * 输出：选中的 MiMo family 被写入全局注册表。
 */
...
/**
 * 注册 XiaomiMiMo 子包内置的全部 family。
 * 输入：无。
 * 输出：MiMo 相关 family 被写入全局注册表。
 */
