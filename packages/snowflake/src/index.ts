/**
 * Snowflake family 包公共入口。
 * 输入：Snowflake family 名称或其模型别名。
 * 输出：自动注册 Snowflake 内置 family，并复用 core 的公共 API。
 */
...
const BUILTIN_FAMILIES = [
  {
    ...
    aliases: ["snowflake_arctic_base"],
    models: ["Snowflake/snowflake-arctic-base"],
    modulePath: "./generated/snowflake_arctic_base.js",
  },
  {
    family: "snowflake-arctic-instruct",
    aliases: ["snowflake_arctic_instruct"],
    models: ["Snowflake/snowflake-arctic-instruct"],
    modulePath: "./generated/snowflake_arctic_instruct.js",
  },
] as const

/**
 * 注册 Snowflake 子包内置的 family，可按 family 名称过滤。
 * 输入：可选的 family 名称列表。
 * 输出：选中的 Snowflake family 被写入全局注册表。
 */
...
/**
 * 注册 Snowflake 子包内置的全部 family。
 * 输入：无。
 * 输出：Snowflake 相关 family 被写入全局注册表。
 */
