/**
 * GSAI-ML family 包公共入口。
 * 输入：GSAI-ML family 名称或其模型别名。
 * 输出：自动注册 GSAI-ML 内置 family，并复用 core 的公共 API。
 */
...
const BUILTIN_FAMILIES = [
  {
    family: "llada",
    aliases: [],
    models: ["GSAI-ML/LLaDA-8B-Instruct", "GSAI-ML/LLaDA-1.5"],
    modulePath: "./generated/llada.js",
  },
  {
    family: "llada-base",
    aliases: ["llada_base"],
    models: ["GSAI-ML/LLaDA-8B-Base"],
    modulePath: "./generated/llada_base.js",
  },
  {
    family: "refusion",
    aliases: [],
    models: ["GSAI-ML/ReFusion"],
    modulePath: "./generated/refusion.js",
  },
] as const

/**
 * 注册 GSAI-ML 子包内置的 family。
 * 输入：无。
 * 输出：GSAI-ML 相关 family 被写入全局注册表。
 */
