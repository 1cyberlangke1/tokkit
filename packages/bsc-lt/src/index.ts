/**
 * BSC-LT family 包公共入口。
 * 输入：BSC-LT family 名称或其模型别名。
 * 输出：自动注册 BSC-LT 内置 family，并复用 core 的公共 API。
 */
...
const BUILTIN_FAMILIES = [
  {
    ...
    modulePath: "./generated/salamandra.js",
  },
  {
    family: "salamandra-instruct",
    aliases: ["salamandra_instruct"],
    models: ["BSC-LT/salamandra-2b-instruct", "BSC-LT/salamandra-7b-instruct"],
    modulePath: "./generated/salamandra_instruct.js",
  },
] as const

/**
 * 注册 BSC-LT 子包内置的 family。
 * 输入：无。
 * 输出：BSC-LT 相关 family 被写入全局注册表。
 */
