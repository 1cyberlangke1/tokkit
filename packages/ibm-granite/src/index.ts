...
const BUILTIN_FAMILIES = [
  ...
  },
  {
    ...
    aliases: ["granite_7b_base"],
    models: ["ibm-granite/granite-7b-base"],
    modulePath: "./generated/granite_7b_base.js",
  },
  {
    family: "granite-7b-instruct",
    aliases: ["granite_7b_instruct"],
    models: ["ibm-granite/granite-7b-instruct"],
    modulePath: "./generated/granite_7b_instruct.js",
  },
  {
    family: "granite-code-base",
    aliases: ["granite_code_base"],
    models: [
    ...
    modulePath: "./generated/granite_code_base.js",
  },
  {
    family: "granite-4",
    aliases: ["granite_4"],
...
/**
 * 注册 IBM Granite 子包内置的 family，可按 family 名称过滤。
 * 输入：可选的 family 名称列表。
 * 输出：选中的 Granite family 被写入全局注册表。
 */
