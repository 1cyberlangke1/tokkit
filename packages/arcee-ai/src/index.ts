/**
 * Arcee AI family 包公共入口。
 * 输入：Arcee AI family 名称或其模型别名。
 * 输出：自动注册 Arcee AI 内置 family，并复用 core 的公共 API。
 */
...
const BUILTIN_FAMILIES = [
  {
    ...
    aliases: ["trinity_large_truebase"],
    models: ["arcee-ai/Trinity-Large-TrueBase"],
    modulePath: "./generated/trinity_large_truebase.js",
  },
  {
    family: "trinity-large",
    aliases: ["trinity_large"],
    models: ["arcee-ai/Trinity-Large-Base", "arcee-ai/Trinity-Large-Preview"],
    modulePath: "./generated/trinity_large.js",
  },
  {
    family: "trinity-large-thinking",
    aliases: ["trinity_large_thinking"],
    models: ["arcee-ai/Trinity-Large-Thinking"],
    modulePath: "./generated/trinity_large_thinking.js",
  },
] as const

/**
 * 注册 Arcee AI 子包内置的 family。
 * 输入：无。
 * 输出：Arcee AI 相关 family 被写入全局注册表。
 */
