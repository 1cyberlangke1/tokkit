/**
 * Dream-org family 包公共入口。
 * 输入：Dream-org family 名称或其模型别名。
 * 输出：自动注册 Dream-org 内置 family，并复用 core 的公共 API。
 */
...
const BUILTIN_FAMILIES = [
  {
    family: "dream-v0",
    aliases: ["dream_v0", "dream-coder-v0", "dream_coder_v0"],
    models: [
    ...
    modulePath: "./generated/dream_v0.js",
  },
  {
    family: "dreamon-v0",
    aliases: ["dreamon_v0"],
    models: ["Dream-org/DreamOn-v0-7B"],
    modulePath: "./generated/dreamon_v0.js",
  },
] as const

/**
 * 注册 Dream-org 子包内置的 family。
 * 输入：无。
 * 输出：Dream-org 相关 family 被写入全局注册表。
 */
